...
The script `export-snapshot-to-s3` facilitates the export, by providing the according classpath, extending the Hadoop configuration with the S3 configuration, and calling `hbase snapshot export`.
