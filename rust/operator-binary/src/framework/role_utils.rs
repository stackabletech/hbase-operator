...
//! `smooth-operator` branch, with simplifications appropriate for hbase-operator.
//!
...
//!   implement `Merge`. HBase uses `JavaCommonConfig`, which intentionally does not
...
/// HBase-friendly view of a validated, merged `RoleGroup`.
